package main.java.com.termux.filemanage.filemanager.view;
...
class PathButtonLayout extends LinearLayout implements OnLongClickListener {
    ...
    private void init() {
        ...
        mPathDrawables.put("/data/data/com.termux/files", R.drawable.ic_launcher);

        Toast.makeText(getContext(), "点击左上角回linux目录", Toast.LENGTH_LONG).show();
    }
