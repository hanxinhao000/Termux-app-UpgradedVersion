...
import main.java.com.termux.filemanage.filemanager.FileHolderListAdapter;
import main.java.com.termux.filemanage.filemanager.FileManagerApplication;
import main.java.com.termux.filemanage.filemanager.files.DirectoryContents;
import main.java.com.termux.filemanage.filemanager.files.DirectoryScanner;
...
public abstract class FileListFragment extends ListFragment {
    ...
    public FileHolderListAdapter mAdapter;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case DirectoryScanner.MESSAGE_SET_PROGRESS:
                    // ignore
                    Toast.makeText(getContext(), "XINHAO_HAN", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    }
