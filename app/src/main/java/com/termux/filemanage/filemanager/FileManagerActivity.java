...
import main.java.com.termux.filemanage.filemanager.bookmarks.BookmarkListActivity;
import main.java.com.termux.filemanage.filemanager.compatibility.HomeIconHelper;
...
import main.java.com.termux.filemanage.filemanager.util.FileUtils;
...
import main.java.com.termux.filemanage.util.MenuIntentOptionsWithIcons;
...
public class FileManagerActivity extends DistributionLibraryFragmentActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        getActionBar().setTitle("点击回linux目录");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_donate:
               /* ArrayList<FileHolder> mFiles = new ArrayList<>();

                FileHolder fileHolder = new FileHolder(new File("/data/data/com.termux/files"), true);

                mFiles.add(fileHolder);
                mFragment.mFiles = mFiles;
