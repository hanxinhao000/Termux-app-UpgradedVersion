             ...
             /*   TermuxApplication.mHandler.post(new Runnable() {
                ...
                if (createFile == null) {
                    TermuxApplication.mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(TermuxApplication.mContext, "系统盘创建失败,请使用全手动模式恢复", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                ...
                TermuxApplication.mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        myDialog.dismiss();
                        Toast.makeText(TermuxApplication.mContext, "开始恢复..", Toast.LENGTH_SHORT).show();
