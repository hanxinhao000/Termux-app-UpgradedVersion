package main.java.com.termux.windows;
...
import main.java.com.termux.app.dialog.EndDialog;
import main.java.com.termux.app.dialog.FileListDialog;
import main.java.com.termux.app.dialog.LoadingDialog;
import main.java.com.termux.app.dialog.SwitchQemuDialog;
    ...
    private void isQemuExe() {
        ...
        dis_install.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ab.setTitle(UUtils.getString(R.string.安装vnc显示插件));
...
*/
    ...
    private void getIso(){
        ...
        ab.setTitle(UUtils.getString(R.string.获取镜像655465));
        ...
        ab.setPositiveButton(UUtils.getString(R.string.前往), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent();
                intent.setData(Uri.parse("https://pan.baidu.com/s/10dYWmCR4YJ0hAquCa7Cglw"));//Url 就是你要打开的网址
                intent.setAction(Intent.ACTION_VIEW);
                startActivity(intent); //启动浏览器
