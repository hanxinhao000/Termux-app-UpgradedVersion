...
//        }
    ...
    public String createGroup(String name) {
        ...
        if(index == -1) {
            ...
            return set(file, name, new String[]{APPS_ATTRIBUTE}, new String[]{Tuils.EMPTYSTRING});
        }
    ...
    public String groupBgColor(String name, String color) {
        ...
        return set(file, name, new String[]{BGCOLOR_ATTRIBUTE}, new String[]{color});
    }
    ...
    public String groupForeColor(String name, String color) {
        ...
        return set(file, name, new String[]{FORECOLOR_ATTRIBUTE}, new String[]{color});
    }
