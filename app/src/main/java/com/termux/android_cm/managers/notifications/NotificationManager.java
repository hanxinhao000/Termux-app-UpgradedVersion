package main.java.com.termux.android_cm.managers.notifications;
...
import static main.java.com.termux.android_cm.managers.xml.XMLPrefsManager.resetFile;
...
public class NotificationManager implements XMLPrefsElement {
    ...
    public static String setState(String pkg, boolean state) {
        return set(new File(Tuils.getFolder(), PATH), pkg, new String[] {ENABLED_ATTRIBUTE}, new String[] {String.valueOf(state)});
    }

    public static String setColor(String pkg, String color) {
        return set(new File(Tuils.getFolder(), PATH), pkg, new String[] {ENABLED_ATTRIBUTE, COLOR_ATTRIBUTE}, new String[] {String.valueOf(true), color});
    }

    public static String setFormat(String pkg, String format) {
        return set(new File(Tuils.getFolder(), PATH), pkg, new String[] {FORMAT_ATTRIBUTE}, new String[] {format});
    }
