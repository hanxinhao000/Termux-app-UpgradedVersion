 ...
 **/
public class FileInstallServerListDialog extends BaseDialogCentre {
    ...
    public FileInstallServerListDialog(@NonNull Context context) {
        super(context);
    }

    public FileInstallServerListDialog(@NonNull Context context, int themeResId) {
    ...
    public void setFilePath(File filePath){
        ...
        if(files != null && files.length > 0){
            ...
            tv_empty.setText(UUtils.getString(R.string.当前目录下没有文件dsfsd));
    ...
    void initViewDialog(View mView) {
        file =  new File(Environment.getExternalStorageDirectory(),"/xinhao/server");
        ...
        def_txt.setVisibility(View.GONE);
