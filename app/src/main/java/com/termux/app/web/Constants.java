...
/**
 * @author ZEL
 * @create By ZEL on 2020/12/22 16:58
 **/
public class Constants {
    ...
    public static final String INTERNAL_LOCATION = "/data/data/com.termux/files/home/.components";
    ...
    public static final String MYSQL_MONITOR_SBIN_LOCATION = "~/.components/components/mysql/sbin/mysql-monitor";
